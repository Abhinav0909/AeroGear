                        ...
                        <div className="p-4 space-y-10 md:space-y-0 md:grid md:grid-cols-2">
                            ...
                            <div className="md:flex md:flex-col md:justify-center lg:pr-16">
                                ...
                                <div className="relative mt-4 font-sourceSerifPro outline ">
                                    <input type="text" name="username" placeholder=" " ref={email} className="block w-full pb-2 pl-3 text-lg text-gray-800 placeholder-gray-400 bg-transparent border-b-2 border-gray-400 appearance-none rounded-xl focus:border-green-400 focus:outline-none" />
                                ...
                                <div className="relative mt-8 font-sourceSerifPro outline ">
                                    <input type="password" name="username" placeholder=" " ref={password} className="block w-full pb-2 pl-3 text-lg text-gray-800 placeholder-gray-400 bg-transparent border-b-2 border-gray-400 appearance-none rounded-xl focus:border-green-400 focus:outline-none" required />
                                ...
                                <div className="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300 cursor-pointer shadow-lg">
                                    <div className="flex items-center justify-center">
                                        <img src={google_logout} alt="google" className="w-4" />
